...
//    @Query("SELECT c FROM CardBenefitDetailEntity c WHERE c.largeCategoryId = :largeCategoryId ORDER BY l. DESC limit 3")
//    CardBenefitDetailEntity findTop3ByLargeCategoryIdOrderByDiscountCostDesc(int largeCategortId);
