...
(
    ...
    org_code        varchar(10)     not null                            COMMENT '기관 번호',
...
(
    ...
    phone_number varchar(11)    not null                            COMMENT '휴대폰 번호("-"없이 11자리)'
);
...
(
    ...
    card_identifier varchar(64)     not null                        COMMENT '카드 식별자 값',
    card_number     varchar(16)     not null                        COMMENT '카드 번호("-"없이 16자리)',
    card_cvc        varchar(3)      not null                        COMMENT '카드 cvc(3자리)',
    card_password   varchar(4)      not null                        COMMENT '카드 비밀번호(4자리)',
    card_member     int             not null                        COMMENT '본인/가족 (0:본인, 1:가족)',
    expired_year    varchar(2)      not null                        COMMENT '카드 유효기간 년(2자리)',
    expired_month   varchar(2)      not null                        COMMENT '카드 요휴기간 월(2자리)',
...
(
    ...
    approved_num      varchar(21)   not null                        COMMENT '승인 번호',
    approved_dtime    datetime      not null                        COMMENT '승인 일시',
    ...
    merchant_regno    varchar(12)   not null                        COMMENT '사업자 등록번호 "-"포함',
