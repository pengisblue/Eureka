export const CATEGORY = [
  ...
  { id: 2, name: "주유", path: require("../../assets/CategoryIcon/2.png") },
  { id: 3, name: "마트", path: require("../../assets/CategoryIcon/3.png") },
  {
    id: 4,
    name: "편의점",
    path: require("../../assets/CategoryIcon/4.png"),
  },
  { id: 5, name: "통신", path: require("../../assets/CategoryIcon/5.png") },
  {
    id: 6,
    name: "온라인쇼핑",
    path: require("../../assets/CategoryIcon/6.png"),
  },
  { id: 7, name: "쇼핑", path: require("../../assets/CategoryIcon/7.png") },
  {
    id: 8,
    name: "배달앱",
