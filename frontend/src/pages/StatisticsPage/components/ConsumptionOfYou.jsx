...
import ConsumptionCategoryList from "./ConsumptionOfYouComponents/ConsumptionCategoryList";import { useDispatch } from "react-redux";
...
function ConsumptionOfYou() {
  ...
  useEffect(() => {
    ...
    const processCategories = (categories) => {
      ...
      // 나머지 "그외" 합산
      const others = categories.slice(4).reduce((acc, curr) => acc + curr.consumption, 0);
 ...
 const LastCategory = processCategories(categories)
  ...
  return (
    <View style={styles.container}>
      ...
      <HorizontalBarGraph categories={LastCategory} totalConsump={totalConsumption} />
